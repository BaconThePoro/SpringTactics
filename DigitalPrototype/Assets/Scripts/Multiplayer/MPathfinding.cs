...
public class MPathfinding {
    ...
    private MGameController gController = null;
    ...
    public MPathfinding(int width, int height, Tilemap newGrid) {
        Instance = this;
        grid = new Grid<PathNode>(width, height, 10f, Vector3.zero, (Grid<PathNode> g, int x, int y) => new PathNode(g, x, y));
        collisionGrid = newGrid;
        gController = GameObject.Find("GameController").GetComponent<MGameController>();
    }
